...
export const News = () => {
	...
	return (
		<section
			id="news"
			className="bg-gradient-to-b from-blue-500 to-neutral-950 min-h-[calc(100vh-5rem)] w-full flex flex-col items-center justify-between border-b-2 p-6 md:px-16 lg:px-24 xl:px-32 gap-3"
		>
