...
export const NewsCard = ({ item: { title, body, imageUrl, imageAlt } }) => {
	return (
		<div className="flex flex-col gap-3 border p-3 rounded-lg shadow-lg shadow-emerald-600 hover:shadow-xl hover:shadow-emerald-600 select-none">
