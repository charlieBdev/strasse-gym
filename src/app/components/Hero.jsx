...
const Hero = () => {
	...
	return (
		<section
			ref={ref}
			id='hero'
			className='relative mt-20 min-h-[calc(100svh-5rem)] w-full flex flex-col items-center justify-between gap-3 px-6 md:px-16 lg:px-24 xl:px-32'
			style={{
		...
		>
			...
			>
				<div className='text-center text-lg md:text-xl lg:text-2xl xl:text-3xl flex flex-col gap-10 w-full select-none bg-neutral-950 opacity-90 p-6 drop-shadow-xl rounded-lg'>
					<h2 className='opacity-100 tracking-wide'>{slogan}</h2>
					...
					<h3 className='text-md md:text-lg lg:text-xl xl:text-2xl text-gray-400'>
